    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-4 gap-4 mb-8">
            <div class="bg-white rounded-xl p-5 shadow-sm">
                <p class="text-sm text-gray-500 mb-1">總任務數</p>
                <p class="text-3xl font-bold text-gray-800">{{ taskStore.totalTasks }}</p>
            </div>
            <div class="bg-white rounded-xl p-5 shadow-sm">
            ...
            <div class="bg-white rounded-xl p-5 shadow-sm">
                <p class="text-sm text-gray-500 mb-1">進行中</p>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="bg-white rounded-xl p-5 shadow-sm">
                <h3 class="text-base font-semibold text-gray-700 mb-4">任務狀態分佈</h3>
                <canvas ref="pieChartRef" style="max-height: 500px;"></canvas>
            ...
            <div class="bg-white rounded-xl p-5 shadow-sm">
                <h3 class="text-base font-semibold text-gray-700 mb-4">任務完成進度</h3>
